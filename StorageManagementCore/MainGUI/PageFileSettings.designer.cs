namespace StorageManagementTool.MainGUI
{
    partial class PagefileSettings
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.PagefileDrive_lbl = new System.Windows.Forms.Label();
         ...
         this.SwapfileStepBackward_btn = new System.Windows.Forms.Button();
         ...
         this.PagefileSettings_gb.Controls.Add(this.PagefileDrive_lbl);
         ...
         // PagefileDrive_lbl
         // 
         this.PagefileDrive_lbl.AutoSize = true;
         this.PagefileDrive_lbl.Location = new System.Drawing.Point(6, 16);
         this.PagefileDrive_lbl.Name = "PagefileDrive_lbl";
         this.PagefileDrive_lbl.Size = new System.Drawing.Size(137, 13);
         this.PagefileDrive_lbl.TabIndex = 5;
         this.PagefileDrive_lbl.Text = "Speicherort der pagefile.sys";
         // 
         ...
         this.SwapfileStepBackward_btn.TabIndex = 1;
         this.SwapfileStepBackward_btn.Text = "Schritt zurück";
         this.SwapfileStepBackward_btn.UseVisualStyleBackColor = true;
         this.SwapfileStepBackward_btn.Click += new System.EventHandler(this.SwapfileStepBackward_btn_Click);
         // 
        ...
        private System.Windows.Forms.Label PagefileDrive_lbl;
        ...
        private System.Windows.Forms.Button SwapfileStepBackward_btn;
