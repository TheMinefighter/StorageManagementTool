	...
	public partial class ShellFolder {
		public static class KnownShellFolders {
			...
			public static readonly ShellFolder CDBurning =
				new ShellFolder("CDBurning", "9E52AB10-F80D-49DF-ACB8-4330F5687855", true, true,@"%USERPROFILE%\AppData\Local\Microsoft\Windows\Burn\Burn");
			...
			public static readonly ShellFolder CommonAdminTools =
				new ShellFolder("CommonAdminTools", "D0384E7D-BAC3-4797-8F14-CBA229B392B5", false, true, @"%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\Administrative Tools");
			...
			public static readonly ShellFolder CommonPrograms =
				new ShellFolder("CommonPrograms", "0139D44E-6AFE-49F2-8690-3DAFCAE6FFB8", false, true, @"%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs");

			public static readonly ShellFolder CommonStartMenu =
				new ShellFolder("CommonStartMenu", "A4115719-D62E-491D-AA7C-E74B8BE3B067", false, true, @"%PROGRAMDATA%\Microsoft\Windows\Start Menu");

			public static readonly ShellFolder CommonStartup =
				new ShellFolder("CommonStartup", "82A5EA35-D9CD-47C5-9629-E15D2F714E6E", false, true, @"%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\Startup");

			public static readonly ShellFolder CommonTemplates =
				new ShellFolder("CommonTemplates", "B94237E7-57AC-4347-9151-B08C6C32D1F7", false, true, @"%PROGRAMDATA%\Microsoft\Windows\Templates");
			...
			public static readonly ShellFolder Cookies =
				new ShellFolder("Cookies", "2B0F765D-C0E9-4171-908E-08A611B84FF6", true, true, @"%USERPROFILE%\AppData\Local\Microsoft\Windows\INetCookies");
			...
			public static readonly ShellFolder GameTasks =
				new ShellFolder("GameTasks", "054FAE61-4DD8-4787-80B6-090220C4B700", true, false, @"%USERPROFILE%\AppData\Local\Microsoft\Windows\GameExplorer");

			public static readonly ShellFolder History =
				new ShellFolder("History", "D9DC8A3B-B784-432E-A781-5A1130A75963", true, true, @"%USERPROFILE%\AppData\Local\Microsoft\Windows\History");

			public static readonly ShellFolder InternetCache =
				new ShellFolder("InternetCache", "352481E8-33BE-4251-BA85-6007CAEDCF9D", true, false, @"%USERPROFILE%\AppData\Local\Microsoft\Windows\INetCache");
			...
			public static readonly ShellFolder LocalAppDataLow =
				new ShellFolder("LocalAppDataLow", "A520A1A4-1780-4FF6-BD18-167343C5AF16", true, false, @"%USERPROFILE%\AppData\LocalLow");
			...
			public static readonly ShellFolder NetHood =
				new ShellFolder("NetHood", "C5ABBF53-E17F-4121-8900-86626FC2C973", true, false, @"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Network Shortcuts");
			...
			public static readonly ShellFolder PrintHood =
				new ShellFolder("PrintHood", "9274BD8D-CFD1-41C3-B35E-B13F55A758F4", true, false, @"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Printer Shortcuts");
			...
			public static readonly ShellFolder ProgramFiles =
				new ShellFolder("ProgramFiles", "905e63b6-c1bf-494e-b29c-65b732d3d21a", false, false, @"%HOMEDRIVE%\Program Files (x86)");
			...
			public static readonly ShellFolder ProgramFilesX86 =
				new ShellFolder("ProgramFilesX86", "7C5A40EF-A0FB-4BFC-874A-C0F2E0B9FA8E", false, false, @"%HOMEDRIVE%\Program Files (x86)");

			public static readonly ShellFolder ProgramFilesCommon =
				new ShellFolder("ProgramFilesCommon", "F7F1ED05-9F6D-47A2-AAAE-29D317C6F066", false, false, @"%PROGRAMFILES(X86)%\Common Files");
			...
			public static readonly ShellFolder Programs =
				new ShellFolder("Programs", "A77F5D77-2E2B-44C3-A6A2-ABA601054A51", true, true, @"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs");
			...
			public static readonly ShellFolder PublicGameTasks =
				new ShellFolder("PublicGameTasks", "DEBF2536-E1A8-4c59-B6A2-414586476AEA", false, true, @"%PROGRAMDATA%\Microsoft\Windows\GameExplorer");
			...
			public static readonly ShellFolder QuickLaunch =
				new ShellFolder("QuickLaunch", "52a4f021-7b75-48a9-9f6b-4b87a210bc8f", true, true, @"%USERPROFILE%\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch");

			public static readonly ShellFolder Recent =
				new ShellFolder("Recent", "AE50C081-EBD2-438A-8655-8A092E34987A", true, true, @"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Recent");
			...
			public static readonly ShellFolder RoamingAppData =
				new ShellFolder("RoamingAppData", "3EB685DB-65F9-4CF6-A03A-E3EF65729F3D", true, true, @"%USERPROFILE%\AppData\Roaming");
			...
			public static readonly ShellFolder SendTo =
				new ShellFolder("SendTo", "8983036C-27C0-404B-8F08-102D10DCFD74", true, true, @"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\SendTo");
			...
			public static readonly ShellFolder StartMenu =
				new ShellFolder("StartMenu", "625B53C3-AB48-4EC1-BA1F-A1EF4146FC19", true, true, @"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Start Menu");

			public static readonly ShellFolder Startup =
				new ShellFolder("Startup", "B97D20BB-F46A-4C97-BA10-5E3608430854", true, true,@"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup");
			...
			public static readonly ShellFolder Templates =
				new ShellFolder("Templates", "A63293E8-664E-48DB-A079-DF759E0509F7", true, false, @"%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Templates");
