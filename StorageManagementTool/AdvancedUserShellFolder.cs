   ...
   public struct AdvancedUserShellFolder {
      ...
      public static void LoadUSF() {
        ...
        new AdvancedUserShellFolder{Name="AddNewPrograms",WindowsIdentifier= new Guid("de61d971-5ebc-4f02-a3a9-6c82895e5c04"),Undefined = true},
         ...
         new AdvancedUserShellFolder{Name="Playlists",WindowsIdentifier= new Guid("DE92C1C7-837F-4F69-A3BB-86E631204A23")},
         new AdvancedUserShellFolder{Name="PrintersFolder",WindowsIdentifier= new Guid("76FC4E2D-D6AD-4519-A663-37BD56068185")},
         new AdvancedUserShellFolder{Name="PrintHood",WindowsIdentifier= new Guid("9274BD8D-CFD1-41C3-B35E-B13F55A758F4")},
         new AdvancedUserShellFolder{Name="Profile",WindowsIdentifier= new Guid("5E6C858F-0E22-4760-9AFE-EA3317B67173")},
         ...
         new AdvancedUserShellFolder{Name="ProgramFilesX64",WindowsIdentifier= new Guid("6D809377-6AF0-444b-8957-A3773F02200E")},
         ...
         new AdvancedUserShellFolder{Name="ProgramFilesCommonX64",WindowsIdentifier= new Guid("6365D5A7-0F0D-45E5-87F6-0DA56B6A4F7D")},
         new AdvancedUserShellFolder{Name="ProgramFilesCommonX86",WindowsIdentifier= new Guid("DE974D24-D9C6-4D3E-BF91-F4455120B917")},
         new AdvancedUserShellFolder{Name="Programs",WindowsIdentifier= new Guid("A77F5D77-2E2B-44C3-A6A2-ABA601054A51")},
         ...
         new AdvancedUserShellFolder{Name="QuickLaunch",WindowsIdentifier= new Guid("52a4f021-7b75-48a9-9f6b-4b87a210bc8f")},
         new AdvancedUserShellFolder{Name="Recent",WindowsIdentifier= new Guid("AE50C081-EBD2-438A-8655-8A092E34987A")},
         new AdvancedUserShellFolder{Name="RecycleBinFolder",WindowsIdentifier= new Guid("B7534046-3ECB-4C18-BE4E-64CD4CB7D6AC")},
         new AdvancedUserShellFolder{Name="ResourceDir",WindowsIdentifier= new Guid("8AD10C31-2ADB-4296-A8F7-E4701232C972")},
         new AdvancedUserShellFolder{Name="RoamingAppData",WindowsIdentifier= new Guid("3EB685DB-65F9-4CF6-A03A-E3EF65729F3D")},
         new AdvancedUserShellFolder{Name="SampleMusic",WindowsIdentifier= new Guid("B250C668-F57D-4EE1-A63C-290EE7D1AA1F")},
         new AdvancedUserShellFolder{Name="SamplePictures",WindowsIdentifier= new Guid("C4900540-2379-4C75-844B-64E6FAF8716B")},
         new AdvancedUserShellFolder{Name="SamplePlaylists",WindowsIdentifier= new Guid("15CA69B3-30EE-49C1-ACE1-6B5EC372AFB5")},
         new AdvancedUserShellFolder{Name="SampleVideos",WindowsIdentifier= new Guid("859EAD94-2E85-48AD-A71A-0969CB56A6CD")},
         new AdvancedUserShellFolder{Name="SavedGames",WindowsIdentifier= new Guid("4C5C32FF-BB9D-43b0-B5B4-2D72E54EAAA4")},
         new AdvancedUserShellFolder{Name="SavedSearches",WindowsIdentifier= new Guid("7d1d3a04-debb-4115-95cf-2f29da2920da")},
         new AdvancedUserShellFolder{Name="SEARCH_CSC",WindowsIdentifier= new Guid("ee32e446-31ca-4aba-814f-a5ebd2fd6d5e")},
         new AdvancedUserShellFolder{Name="SEARCH_MAPI",WindowsIdentifier= new Guid("98ec0e18-2098-4d44-8644-66979315a281")},
         new AdvancedUserShellFolder{Name="SearchHome",WindowsIdentifier= new Guid("190337d1-b8ca-4121-a639-6d472d16972a")},
         new AdvancedUserShellFolder{Name="SendTo",WindowsIdentifier= new Guid("8983036C-27C0-404B-8F08-102D10DCFD74")},
         new AdvancedUserShellFolder{Name="SidebarDefaultParts",WindowsIdentifier= new Guid("7B396E54-9EC5-4300-BE0A-2482EBAE1A26")},
         new AdvancedUserShellFolder{Name="SidebarParts",WindowsIdentifier= new Guid("A75D362E-50FC-4fb7-AC2C-A8BEAA314493")},
         new AdvancedUserShellFolder{Name="StartMenu",WindowsIdentifier= new Guid("625B53C3-AB48-4EC1-BA1F-A1EF4146FC19")},
         new AdvancedUserShellFolder{Name="Startup",WindowsIdentifier= new Guid("B97D20BB-F46A-4C97-BA10-5E3608430854")},
         new AdvancedUserShellFolder{Name="SyncManagerFolder",WindowsIdentifier= new Guid("43668BF8-C14E-49B2-97C9-747784D784B7")},
         new AdvancedUserShellFolder{Name="SyncResultsFolder",WindowsIdentifier= new Guid("289a9a43-be44-4057-a41b-587a76d7e7f9")},
         new AdvancedUserShellFolder{Name="SyncSetupFolder",WindowsIdentifier= new Guid("0F214138-B1D3-4a90-BBA9-27CBC0C5389A")},
         ...
         new AdvancedUserShellFolder{Name="Templates",WindowsIdentifier= new Guid("A63293E8-664E-48DB-A079-DF759E0509F7")},
         new AdvancedUserShellFolder{Name="TreeProperties",WindowsIdentifier= new Guid("5b3749ad-b49f-49c1-83eb-15370fbd4882")},
         new AdvancedUserShellFolder{Name="UserProfiles",WindowsIdentifier= new Guid("0762D272-C50A-4BB0-A382-697DCD729B80")},
         new AdvancedUserShellFolder{Name="UsersFiles",WindowsIdentifier= new Guid("f3ce0f7c-4901-4acc-8648-d5d44b04ef8f")},
         new AdvancedUserShellFolder{Name="Videos",WindowsIdentifier= new Guid("18989B1D-99B5-455B-841C-AB7C74E4DDFC")},
