...
namespace StorageManagementTool
{
    ...
    public static class Program
    {
        ...
        private static void SessionInitalizer()
        {
            ...
            if (File.Exists(Session.Singleton.CfgPath))
            {
                string cfgJsonstring = File.ReadAllText(Session.Singleton.CfgPath);
                Session.Singleton.CfgJson = JsonConvert.DeserializeObject<JSONConfig>(cfgJsonstring);
            }
            else
            {
                Session.Singleton.CfgJson = new JSONConfig();
            }
        }
